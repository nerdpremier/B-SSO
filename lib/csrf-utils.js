...
/**
 * ตรวจสอบความถูกต้องของ CSRF token จาก Request ของผู้ใช้
 * 
 * ใช้เทคนิค Double-Submit Cookie โดยต้องผ่านการตรวจสอบตามลำดับดังนี้:
 * 1. ทั้ง Cookie และ Header ต้องมีค่าส่งมา
 * 2. ค่าใน Cookie ต้องตรงกับค่าใน Header
 * 3. สามารถแยกส่วน (Split) ได้เป็น 2 ส่วน (nonce และ signature)
 * 4. ความยาวของข้อความทั้งสองส่วนต้องเท่ากับ 64 ตัวอักษรพอดี ป้องกันการโจมตีแบบ CPU Abuse
 * 5. ทั้งสองส่วนต้องเป็นค่า Hex ล้วน เพื่อป้องกันการคำนวณ Buffer จากสตริงว่าง
 * 6. ตรวจสอบลายเซ็น HMAC(nonce) === sig ผ่าน Timing Safe Equal เพื่อป้องกัน Timing Attack
 * 
 * @param {import('http').IncomingMessage} req - HTTP Request object
 * @returns {boolean} เป็นจริงหาก CSRF Token ตรวจสอบผ่าน
 */
